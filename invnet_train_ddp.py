...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='InversionNet DDP Training')
    parser.add_argument('-d', '--device', default='cuda')
    parser.add_argument('-ds', '--dataset', default='flatfault-b')
    parser.add_argument('-fs', '--file-size', type=int, default=None)
    parser.add_argument('-ap', '--anno-path', default='split_files')
    parser.add_argument('-t', '--train-anno', default='flatfault_b_train_invnet.txt')
    parser.add_argument('-v', '--val-anno', default='flatfault_b_val_invnet.txt')
    parser.add_argument('-o', '--output-path', default='Invnet_models')
    parser.add_argument('-l', '--log-path', default='Invnet_models')
    parser.add_argument('-n', '--save-name', default='fcn_l1loss_ffb')
